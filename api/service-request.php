...
function saveFile(array $file): string {
    ...
    $ext = $mimeToExt[$mimeType] ?? strtolower(pathinfo($file['name'], PATHINFO_EXTENSION));
...
try {
    ...
    echo json_encode([
        'success' => false,
        'error'   => 'Ocorreu um erro ao processar o pedido. Tente novamente mais tarde.',
    ]);
}
